<template>
    <option selected disabled>Selecciona tipo de vía</option>
    <option value="AP">AP - Apartamento</option>
    <option value="AUT">AUT - Autopista Avenida</option>
    <option value="AV">AV - Avenida</option>
    <option value="AVI">AVI - Anillo Vial</option>
    <option value="AK">AK - Avenida Carrera</option>
    <option value="BG">BG - Bodega</option>
    <option value="BRR">BRR - Barrio</option>
    ...
    <option value="CLI">CLI - Callejón</option>
    <option value="CND">CND - Condominio</option>
    ...
    <option value="DIAG">DIAG - Diagonal</option>
    ...
    <option value="NOR">NOR - Norte</option>
    ...
    <option value="ORD">ORD - Orden Name</option>
